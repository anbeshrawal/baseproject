...
public class Walk : BaseStates
{
    ...
    private void movement(StateManager stateManager)
    {
       if(stateManager.canmove == true && stateManager.isGrounded == true)
        ...
        stateManager.targetSpeed = stateManager.xInput * stateManager.walkSpeed;
   ...
   private void HandleInput(StateManager stateManager)
    {
        ...
        else if (Input.GetKeyDown(KeyCode.LeftShift) && stateManager.xInput != 0)
        {
